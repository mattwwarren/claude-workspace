...
On script exit 2 (malformed input — fail open): treat as `stale: false` and proceed exactly as the unchanged behavior below; log `"impl_guard_staleness_check_failed"` in `friction_highlights`.
