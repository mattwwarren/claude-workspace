...
# neither offered nor possible" (`_context.py::_CAPABLE_PREAMBLE`). Test
# Reviewer is the one role whose job needs to *run* pytest, which a
...
# already repeated across `_context.py`.
