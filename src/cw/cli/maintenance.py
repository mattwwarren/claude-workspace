...
def _report_init_outcome(path: Path, name: str, *, no_onboarding: bool) -> None:
    """Run onboarding (or warn it was skipped) and print the Next steps block."""
...
def init(
    ...
    _report_init_outcome(path, name, no_onboarding=no_onboarding)
