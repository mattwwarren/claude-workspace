...
def _rereview(
    *,
    ...
    Note this path never touches :func:`_build_fix_codex_argv` — it is a
    *review* pass, so ``reasoning_effort`` reaches codex the same way the
    initial pass's does: through ``run_codex_roles`` (#1711).
    """
