...
class TestLaneLs:
    ...
    def test_lane_ls_accepts_client_option(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "ls", "-c", "acme"])
        assert result.exit_code == 0, result.output
        assert "default" in result.output
        assert "urgent" in result.output
    ...
    def test_lane_ls_rejects_positional_and_option_together(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "ls", "acme", "-c", "acme"])
        assert result.exit_code != 0
    ...
    def test_lane_ls_rejects_missing_client(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "ls"])
        assert result.exit_code != 0
...
class TestLaneAdd:
    ...
    def test_lane_add_accepts_client_option(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "add", "fast", "-c", "acme"])
        assert result.exit_code == 0, result.output
...
class TestLaneRm:
    ...
    def test_lane_rm_accepts_client_option(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "rm", "fast", "-c", "acme"])
        assert result.exit_code == 0, result.output
    ...
    def test_lane_rm_rejects_positional_and_option_together(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "rm", "acme", "fast", "-c", "beta"])
        assert result.exit_code != 0
    ...
    def test_lane_rm_rejects_missing_client(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "rm", "fast"])
        assert result.exit_code != 0
...
class TestLanePauseResume:
    ...
    def test_lane_pause_accepts_client_option(
        ...
        runner = CliRunner()
        result = runner.invoke(main, ["lane", "pause", "slow", "-c", "acme"])
        assert result.exit_code == 0, result.output
    ...
    def test_lane_resume_accepts_client_option(
        ...
        runner = CliRunner()
        runner.invoke(main, ["lane", "pause", "slow", "-c", "acme"])
        result = runner.invoke(main, ["lane", "resume", "slow", "-c", "acme"])
        assert result.exit_code == 0, result.output
